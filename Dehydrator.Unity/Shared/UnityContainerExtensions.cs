...
namespace Dehydrator.Unity
{
    ...
    {
        /// <summary>
        /// Registers dehydrating database-backed repository factories for a specific <see cref="DbContext"/>.
        /// </summary>
            ...
            where TDbContext : DbContext, new()
        {
            ...
            container.RegisterType<IReadRepositoryFactory>(
                ...
                new InjectionFactory(c =>
                    new DehydratingReadRepositoryFactory(new DbReadRepositoryFactory(c.Resolve<TDbContext>()))));
            ...
            if (!readOnly)
            {
                container.RegisterType<ICrudRepositoryFactory>(
                    ...
                    new InjectionFactory(c =>
                        new DehydratingCrudRepositoryFactory(new DbCrudRepositoryFactory(c.Resolve<TDbContext>()))));
            }

            return new DatabaseRegistration<TDbContext>(container, readOnly);
        }
    }
}
...
namespace Dehydrator
{
    ...
    public static class PropertyExtensions
    {
        ...
        public static bool IsPoco([NotNull] this Type type) =>
            !type.IsInterface && !type.IsValueType && (type.GetConstructor(new Type[] {}) != null);
        ...
        /// </summary>
        public static bool HasAttribute<TAttribute>([NotNull] this PropertyInfo prop) where TAttribute : Attribute =>
            prop.GetCustomAttributes(typeof(TAttribute), inherit: true).Any();
